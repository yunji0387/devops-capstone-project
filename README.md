...
![Build Status](https://github.com/yunji0387/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
For detailed instructions, please refer to the [Windows 11 Local Setup Guide](win11-local-setup.md).
